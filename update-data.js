...
const POOL_RAW = [
  ...
  ["Logan Morris", "KEYF", 111, 355.0],
  ["Zac Bailey", "FWD", 46, 432.5],
  ["Jeremy Cameron", "KEYF", 47, 431.7],
  ["Jye Amiss", "KEYF", 112, 354.0],
  ...
  ["Connor O'Sullivan", "KEYD", 116, 350.0],
  ["Justin McInerney", "MID", 98, 368.1],
  ["Jack Ross", "MID", 99, 367.1],
  ["James Sicily", "KEYD", 117, 349.0],
  ["Aaron Cadman", "KEYF", 118, 300.0],
  ["Beau McCreery", "MID", 119, 300.0],
  ["Ben Long", "KEYF", 120, 300.0],
  ["Ben Miller", "KEYD", 121, 300.0],
  ["Billy Frampton", "KEYD", 122, 300.0],
  ["Brodie Kemp", "KEYF", 123, 300.0],
  ["Charlie Cameron", "KEYF", 124, 300.0],
  ["Charlie Comben", "KEYD", 125, 300.0],
  ["Connor Idun", "KEYD", 126, 300.0],
  ["Conor Nash", "MID", 127, 300.0],
  ["Cooper Sharman", "KEYF", 128, 300.0],
  ["Cooper Trembath", "KEYF", 129, 300.0],
  ["Corey Durdin", "KEYF", 130, 300.0],
  ["Daniel McStay", "KEYF", 131, 300.0],
  ["Daniel Turner", "KEYD", 132, 300.0],
  ["Ed Langdon", "KEYD", 133, 300.0],
  ["Elliot Yeo", "MID", 134, 300.0],
  ["George Wardlaw", "MID", 135, 300.0],
  ["Harley Reid", "MID", 136, 300.0],
  ["Harry McKay", "KEYF", 137, 300.0],
  ["Harvey Langford", "KEYF", 138, 300.0],
  ["Harvey Thomas", "MID", 139, 300.0],
  ["Heath Chapman", "KEYD", 140, 300.0],
  ["Hugo Garcia", "MID", 141, 300.0],
  ["Isaac Quaynor", "KEYD", 142, 300.0],
  ["Isaiah Dudley", "KEYF", 143, 300.0],
  ["Jack Darling", "KEYF", 144, 300.0],
  ["Jack Ginnivan", "KEYD", 145, 300.0],
  ["Jack Higgins", "KEYF", 146, 300.0],
  ["Jack Silvagni", "KEYD", 147, 300.0],
  ["Jacob Farrow", "KEYD", 148, 300.0],
  ["Jacob Van Rooyen", "KEYF", 149, 300.0],
  ["Jagga Smith", "MID", 150, 300.0],
  ["Jake Stringer", "KEYF", 151, 300.0],
  ["Jake Waterman", "KEYF", 152, 300.0],
  ["James Jordon", "MID", 153, 300.0],
  ["James Peatling", "MID", 154, 300.0],
  ["Jayden Laverde", "KEYD", 155, 300.0],
  ["Joe Richards", "MID", 156, 300.0],
  ["Joel Amartey", "KEYF", 157, 300.0],
  ["Joseph Fonti", "KEYD", 158, 300.0],
  ["Josh Battle", "KEYD", 159, 300.0],
  ["Josh Rachele", "KEYF", 160, 300.0],
  ["Josh Worrell", "KEYD", 161, 300.0],
  ["Kai Lohmann", "KEYF", 162, 300.0],
  ["Karl Amon", "KEYD", 163, 300.0],
  ["Karl Worner", "KEYD", 164, 300.0],
  ["Lachlan McAndrew", "MID", 165, 300.0],
  ["Lachlan Schultz", "MID", 166, 300.0],
  ["Lawson Humphries", "KEYD", 167, 300.0],
  ["Liam Duggan", "KEYD", 168, 300.0],
  ["Liam Ryan", "KEYF", 169, 300.0],
  ["Logan Evans", "KEYD", 170, 300.0],
  ["Logan McDonald", "KEYF", 171, 300.0],
  ["Luke Ryan", "KEYD", 172, 300.0],
  ["Mac Andrew", "KEYD", 173, 300.0],
  ["Marcus Windhager", "MID", 174, 300.0],
  ["Mitch Georgiades", "KEYF", 175, 300.0],
  ["Mitch McGovern", "KEYF", 176, 300.0],
  ["Mitchell Lewis", "KEYF", 177, 300.0],
  ["Murphy Reid", "MID", 178, 300.0],
  ["Nate Caddy", "KEYF", 179, 300.0],
  ["Ned Long", "MID", 180, 300.0],
  ["Nic Newman", "KEYD", 181, 300.0],
  ["Nick Larkey", "KEYF", 182, 300.0],
  ["Oisin Mullin", "MID", 183, 300.0],
  ["Oliver Henry", "KEYF", 184, 300.0],
  ["Patrick Voss", "KEYF", 185, 300.0],
  ["Paul Curtis", "KEYF", 186, 300.0],
  ["Phoenix Gothard", "KEYF", 187, 300.0],
  ["Rory Laird", "KEYD", 188, 300.0],
  ["Ryan Lester", "KEYD", 189, 300.0],
  ["Ryley Sanders", "MID", 190, 300.0],
  ["Sam Berry", "MID", 191, 300.0],
  ["Shannon Neale", "KEYF", 192, 300.0],
  ["Tom McCarthy", "KEYD", 193, 300.0],
  ["Tom McCartin", "KEYD", 194, 300.0],
  ["Tom Sparrow", "MID", 195, 300.0],
  ["Tylar Young", "KEYD", 196, 300.0],
  ["Wil Powell", "MID", 197, 300.0],
  ["Zach Reid", "KEYD", 198, 300.0],
];
...
const SLUG_ALIASES = {
  ...
  "mitch-georgiades": "mitchell-georgiades",
  "mitch-mcgovern": "mitchell-mcgovern",
  "ed-langdon": "edward-langdon",
  "nic-newman": "nicholas-newman",
